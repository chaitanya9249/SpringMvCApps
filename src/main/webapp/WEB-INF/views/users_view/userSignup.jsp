			...
			<div class="nk-form">
				...
				<%-- <div class="alert-inner mg-t-30" id="alertMessageId">
					<div class="alert-list">
						<c:if test="${fn:length(failMessage) gt 0}">
							<div class="alert alert-danger alert-dismissible alert-mg-b-0"
								role="alert">${failMessage}</div>
						</c:if>
				...
				<c:if test="${fn:length(failMessage) gt 0}">
					<div class="alert-inner mg-t-30" id="alertMessageId">
						<div class="alert-list">
							<div class="alert alert-danger alert-dismissible alert-mg-b-0" role="alert">${failMessage}</div>
						</div>
					</div>
				</c:if>
				...
				<form:form action="saveUser" method="post" modelAttribute="empSignup">

					<form:input type="hidden" path="id" name="id" id="employeeId" value="${empSignup.id}"/>

					<div class="input-group">
						<span class="input-group-addon nk-ic-st-pro"><i class="notika-icon notika-support"></i></span>
						<div class="nk-int-st">
							<form:input type="text" path="employeeName" name="employeeName" id="employeeName" value="${empSignup.employeeName}" class="form-control" placeholder="Name" />
						</div>
					</div>
					...
					<div class="input-group">
						<span class="input-group-addon nk-ic-st-pro"><i class="notika-icon notika-support"></i></span>
						<div class="nk-int-st">
							<form:input type="text" path="empEmail" name="empEmail" id="empEmail" value="${empSignup.empEmail}" class="form-control" placeholder="User Name" />
						</div>
					</div>
					...
					<div class="input-group mg-t-15">
						...
						<div class="nk-int-st">
							<form:input type="password" path="empPassword" name="empPassword" id="empPassword" value="${empSignup.empPassword}" class="form-control" placeholder="Password" />
						</div>
					</div>
					...
					<a href="loginView" class="btn btn-login btn-success btn-float">
