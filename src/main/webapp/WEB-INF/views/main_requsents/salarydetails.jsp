		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					...
					<form:form action="saveSalary" modelAttribute="salary" method="post" role="form">
						<div class="cmp-tb-hd cmp-int-hd">
							<h2>Salary Details</h2>
						</div>
						
						<form:input type="hidden" name="salaryId" path="salaryId" id="salaryId" value="${salary.salaryId}" />
							...
							<div class="form-group">
								<div class="row">
									...
									<div class="col-lg-8 col-md-7 col-sm-7 col-xs-12 bootstrap-select fm-cmp-mg">
										<form:select class="selectpicker" data-live-search="true" path="departmentId" name="departmentId"
										 value="${department.departmentId}" id="departmentId">
						...
						<div class="form-example-int form-horizental mg-t-15">
							<div class="form-group">
								<div class="row">
									...
									<div class="col-lg-8 col-md-7 col-sm-7 col-xs-12 bootstrap-select fm-cmp-mg">
										<form:select class="selectpicker" data-live-search="true" path="designationId" name="designationId"
										 value="${salary.designationId}" id="designationId">
											<option>--Select--</option>
											<option>Designation One</option>
											<option>Designation Two</option>
											<option>Designation Three</option>
											<option>Designation Four</option>
											<option>Designation Five</option>
											<option>Designation Six</option>										
									   </form:select>
									</div>
						...
						<div class="form-example-int form-horizental mg-t-15">
							<div class="form-group">
								<div class="row">
									...
									<div class="col-lg-2 col-md-3 col-sm-3 col-xs-12">
										<label class="hrzn-fm">Employee </label>
									</div>
									<div class="col-lg-8 col-md-7 col-sm-7 col-xs-12 bootstrap-select fm-cmp-mg">
										<form:select class="selectpicker" data-live-search="true" path="empId" name="empId" value="${salary.empId}" id="empId">
											<option>--Select--</option>
											<option>Employ One</option>
											<option>Employ Two</option>
											<option>Employ Three</option>
											<option>Employ Four</option>
											<option>Employ Five</option>
											<option>Employ Six</option>										
										</form:select>
									</div>
						...
						<div class="form-example-int form-horizental">
							<div class="form-group">
								<div class="row">
									<div class="col-lg-2 col-md-3 col-sm-3 col-xs-12">
										<label class="hrzn-fm">Anual Income</label>
									</div>
									<div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
										<div class="nk-int-st">
											<form:input type="text" path="salaryPerAnum"
													name="salaryPerAnum" value="${salary.salaryPerAnum}" class="form-control input-sm" 
