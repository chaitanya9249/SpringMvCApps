        ...
        <div class="container">
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					...
					<form:form action="saveLeaveCount" modelAttribute="leaveCount" method="post">
						<div class="cmp-tb-hd cmp-int-hd">
							<h2>Leave Count</h2>
						</div>
						
						<form:input type="hidden" name="leaveId" path="leaveId" id="leaveId" value="${leaveCount.leaveId}" />
								...
								<div class="row">
									...
									<div
										...
										<form:select class="selectpicker" data-live-search="true"
											...
											value="${leaveCount.departmentId}" id="departmentId">
										</form:select>
									</div>
								</div>
							</div>
						...
						<div class="form-example-int form-horizental mg-t-15">
							<div class="form-group">
								<div class="row">
									<div class="col-lg-2 col-md-3 col-sm-3 col-xs-12">
										<label class="hrzn-fm">Leave Count</label>
									</div>
									<div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
										<div class="nk-int-st">
											<form:input type="text" path="numberOfLeaves" name="numberOfLeaves" value="${leaveCount.numberOfLeaves}" id="numberOfLeaves" class="form-control input-sm" placeholder="Enter Number of leaves" />
										</div>
									</div>
								</div>
							</div>
                    ...
                    <div class="data-table-list">
                        ...
                        <div class="table-responsive">
                            <table id="data-table-basic" class="table table-striped">
                                ...
                                <tbody>
                                    <c:forEach items="${leaveCountList}" var="leaveCountList">
										<tr>
											<td><a href="editLeaveCount?leaveId=<c:out value='${leaveCountList.leaveId}'/>"><c:out value="${leaveCountList.leaveId}" /></a></td>
											<td><c:out value="${leaveCountList.departmentName}" /></td>
											<td><c:out value="${leaveCountList.numberOfLeaves}" /></td>
										</tr>
									</c:forEach>
                                </tbody>
                            </table>
