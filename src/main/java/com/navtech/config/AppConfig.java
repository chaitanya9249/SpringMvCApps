...
import com.navtech.model.TeamStructure;
...
@ComponentScans(value = { @ComponentScan("com.navtech.dao"),
      @ComponentScan("com.navtech.service") })
public class AppConfig {
   ...
   public LocalSessionFactoryBean getSessionFactory() {
      ...
      factoryBean.setAnnotatedClasses(Attendance.class,Departments.class,Designations.class,Employee.class,EmployeeProfile.class,
    		  HolidaysList.class,HolidaysList.class,LeaveCount.class,LeaveRequest.class,SalaryDetails.class,User_Roles.class,UserRegistration.class,
    		  Users.class,RolesData.class,TeamStructure.class);
      return factoryBean;
   }
